...
(function (ev) {
    ...
    var host = null;
    var clicked = (ev && ev.target && ev.target.closest) ? ev.target.closest('[id$=".btn_Plot"]') : null;
    if (clicked) {
        var hostId = clicked.id.split(".btn_Plot")[0];
        host = TcHmi.Controls.get(hostId);
    }

    var uid = "AC_PlotUcParams" + '_' + (host ? String(host.getId()).replace(/[^A-Za-z0-9_]/g, '_') : 'popup');
    ...
    function buildDialog() {
        ...
        (function () {
            ...
            {
                "kind": "enum",
                "symbol": "%s%ADS.AF_PLC.MAIN::eStep%/s%",
                "color": "#a855f7",
                "dash": "dot",
                "mode": "all",
                "onlyMapped": false,
            ...
            (function () {
                ...
                axes[0].label = String(gv("AxTitle", axes[0].label)); axes[0].loc = '';
                axes[0].min = Number(gv("AxMin", axes[0].min));
                axes[0].max = Number(gv("AxMax", axes[0].max));
                var _ss0 = acWrapP(gv("SigPath", '')); if (_ss0) series[0].symbol = _ss0;
                series[0].label = String(gv("SigName", series[0].label)); series[0].loc = '';
                refLines[0].value = Number(gv("RefVal", refLines[0].value));
                refLines[0].label = String(gv("RefLabel", refLines[0].label)); refLines[0].loc = '';
                var _ms0 = acWrapP(gv("MkPath", '')); if (_ms0) eventMarkers[0].symbol = _ms0;
                eventMarkers[0].mappings[0].value = String(gv("MapVal0", eventMarkers[0].mappings[0].value));
            })();
            ...
            if (SHOW_TOOLBAR || ZOOM_ENABLED) {
                ...
                var cap = document.createElement('span'); cap.style.cssText = 'flex:1 1 auto;'; if (SHOW_TOOLBAR) cap.textContent = "Verlauf";
                bar.appendChild(cap);
...
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"usercontrol","fnName":"AC_PlotUcParams","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":400,"columns":1,"hostSuffix":".btn_Plot","blocks":[{"id":"b103","type":"plot","col":0,"caption":"Verlauf","captionLoc":"","dataMode":"live","followSec":300,"historyLoadSec":3600,"maxPoints":3600,"plotHeight":360,"showRangeslider":true,"showXAxis":true,"showToolbar":true,"zoomEnabled":true,"nowLabel":"Jetzt","nowLoc":"","resetLabel":"Zurücksetzen","resetLoc":"","timeButtons":[{"id":"t54","count":1,"unit":"hour","label":"1 h"},{"id":"t55","count":6,"unit":"hour","label":"6 h"},{"id":"t56","count":24,"unit":"hour","label":"24 h"},{"id":"t57","count":7,"unit":"day","label":"1 Woche"},{"id":"t58","count":0,"unit":"all","label":"Alle"}],"axes":[{"id":"a53","label":"Druck","loc":"","unit":"%","color":"#3b82f6","autoscale":false,"min":0,"max":100,"labelParam":"AxTitle","minParam":"AxMin","maxParam":"AxMax"}],"series":[{"id":"s59","symbol":"ADS.AF_PLC.MAIN::fWert","label":"Signal","loc":"","color":"#22c55e","axisId":"a53","symbolParam":"SigPath","labelParam":"SigName"}],"refLines":[{"id":"r60","mode":"fixed","value":90,"symbol":"ADS.AF_PLC.MAIN.…::rGrenzwert","label":"Grenze","loc":"","color":"#ef4444","dash":"dash","axisId":"a53","valueParam":"RefVal","labelParam":"RefLabel"}],"eventMarkers":[{"id":"m61","kind":"enum","symbol":"ADS.AF_PLC.MAIN::eStep","color":"#a855f7","dash":"dot","mode":"all","onlyMapped":false,"markInitial":false,"mappings":[{"id":"mm64","value":"1","label":"Auto","loc":"","valueParam":"MapVal0"}],"showValue":true,"prefix":"","prefixLoc":"","decimals":0,"symbolParam":"MkPath"}]}]}
