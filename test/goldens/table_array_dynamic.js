...
(function () {
    ...
    function buildDialog() {
        ...
        box.style.cssText = 'position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);' +
            ...
            'min-width:320px;width:640px;max-width:calc(100vw - 32px);max-height:calc(100vh - 48px);' +
        ...
        (function () {
            ...
            var ARRAY_SYMBOL = "%s%ADS.AF_PLC.MAIN.GVL.aAlarms%/s%";
            var COUNT_SYMBOL = "%s%ADS.AF_PLC.MAIN.GVL.nAlarmCount%/s%";
            var ARRAY_COUNT = 20;
            var START_INDEX = 0;
            var SHOW_INDEX = false;
            var SEARCH_ON = true;
            var PAGE_SIZE = 5; // 0 = keine Pagination
            var STRIPED = true;
...
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"event","fnName":"AC_TableArray","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":640,"columns":1,"hostSuffix":".btn_PopUp","blocks":[{"id":"b49","type":"table","col":0,"caption":"Alarme","captionLoc":"","dataSource":"array","arraySymbol":"ADS.AF_PLC.MAIN.GVL.aAlarms","arrayCount":20,"countSymbol":"ADS.AF_PLC.MAIN.GVL.nAlarmCount","startIndex":0,"showIndex":false,"columns":[{"id":"tc51","kind":"read","header":"Wert","headerLoc":"","headerIcon":"","headerIconColor":"","member":"rValue","unit":"%","decimals":0,"label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":true,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1},{"id":"tc52","kind":"bool","header":"Aktiv","headerLoc":"","headerIcon":"","headerIconColor":"","member":"xActive","unit":"","decimals":"","label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1},{"id":"tc53","kind":"enum","header":"Klasse","headerLoc":"","headerIcon":"","headerIconColor":"","member":"eClass","unit":"","decimals":"","label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[{"id":"tm54","value":"0","label":"Info","loc":"","color":"blue","icon":"info"},{"id":"tm55","value":"1","label":"Warnung","loc":"","color":"yellow","icon":"info"}],"sortable":false,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1},{"id":"tc56","kind":"button","header":"Quittieren (Member)","headerLoc":"","headerIcon":"","headerIconColor":"","member":"","unit":"","decimals":"","label":"Quittieren","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"fn","fnName":"AC_HMI_AckRow","paramSource":"member","paramMember":"nAlarmId","paramCol":-1},{"id":"tc57","kind":"button","header":"Kopieren (Spalte)","headerLoc":"","headerIcon":"","headerIconColor":"","member":"","unit":"","decimals":"","label":"Kopieren","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"fn","fnName":"AC_HMI_CopyRow","paramSource":"col","paramMember":"","paramCol":0},{"id":"tc58","kind":"button","header":"Info (Index)","headerLoc":"","headerIcon":"","headerIconColor":"","member":"","unit":"","decimals":"","label":"Info","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"fn","fnName":"AC_HMI_RowInfo","paramSource":"index","paramMember":"","paramCol":-1},{"id":"tc59","kind":"button","header":"Aktualisieren","headerLoc":"","headerIcon":"","headerIconColor":"","member":"","unit":"","decimals":"","label":"Refresh","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"fn","fnName":"AC_HMI_Refresh","paramSource":"none","paramMember":"","paramCol":-1}],"rows":[],"search":true,"pageSize":5,"striped":true,"showHeader":true,"watchLimit":30,"pollMs":800,"rules":[{"id":"tu62","colIndex":2,"op":"==","value":"1","target":"cell","color":"yellow"}],"rowFilters":[{"id":"tf63","colIndex":0,"op":"notZero","value":""},{"id":"tf64","colIndex":1,"op":"==","value":"true"}],"defaultSortCol":-1,"defaultSortDir":"asc"}]}
