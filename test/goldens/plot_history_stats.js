...
(function () {
    ...
    function buildDialog() {
        ...
        (function () {
            ...
            var DATA_MODE        = "history"; // 'live' | 'history'
            var FOLLOW_WINDOW_MS = 900000;
            var HISTORY_LOAD_MS  = 7200000;
            var MAX_POINTS       = 5000;
            var MAX_EVENT_LINES  = 40;
            var SHOW_RANGESLIDER = false;
            var SHOW_X_AXIS      = false;
            ...
            var followMode = false, suppressRelayout = false, initialXRange = null, lastNewestMs = 0, setupDone = false;
            ...
            // ── Statistik-Tabelle (Bezug: sichtbarer x-Ausschnitt, live aktualisiert) ──
            ...
            function initPlot(pp) {
                ...
                ensurePlotly(function () {
                    ...
                    plotDiv.on('plotly_relayout', function (ev) { if (suppressRelayout || !setupDone) return; if (ev['xaxis.autorange'] === true) { followMode = true; reapplyView(); } else if (ev['xaxis.range'] !== undefined || ev['xaxis.range[0]'] !== undefined) { followMode = false; } updateStats(); });
                    if (DATA_MODE === 'history') {
                        ...
                        trendHandle = subscribeTrendData(symbolList, lookbackIso, Math.max(200, plotDiv.clientWidth || 960), trendChartName, function (seriesData) {
                            ...
                            }).then(function () { suppressRelayout = false; updateStats(); }).catch(function () { suppressRelayout = false; });
                        });
                    } else {
                        // Reiner Live-Modus (unveraendert): pro Signal per TcHmi.Symbol.watch anhaengen.
                        series.forEach(function (s, i) { subscribeP(s.symbol, function (v) { if (!plotDiv) return; var num = Number(v); if (isNaN(num)) return; window.Plotly.extendTraces(plotDiv, { x: [[new Date()]], y: [[num]] }, [i], MAX_POINTS); applyFollow(); updateStats(); }); });
                    }
                    ...
                    resize(); setupDone = true; updateStats();
            ...
            if (SHOW_TOOLBAR || ZOOM_ENABLED) {
                ...
                var cap = document.createElement('span'); cap.style.cssText = 'flex:1 1 auto;'; if (SHOW_TOOLBAR) cap.textContent = "Langzeit";
                bar.appendChild(cap);
            ...
            // Statistik-Tabelle unter dem Plot (einklappbar)
            ...
            teardowns.push(function () {
                ...
                plotDiv = null; wrapper = null; statsWrap = null; statsCells = []; statsRangeEl = null;
            });
...
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"event","fnName":"AC_TrendHistory","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":400,"columns":1,"hostSuffix":".btn_PopUp","blocks":[{"id":"b47","type":"plot","col":0,"caption":"Langzeit","captionLoc":"","dataMode":"history","followSec":900,"historyLoadSec":7200,"maxPoints":5000,"plotHeight":280,"showRangeslider":false,"showXAxis":false,"showToolbar":false,"zoomEnabled":false,"nowLabel":"Jetzt","nowLoc":"","resetLabel":"Zurücksetzen","resetLoc":"","timeButtons":[{"id":"t36","count":2,"unit":"hour","label":"2 h"},{"id":"t37","count":1,"unit":"day","label":"1 Tag"},{"id":"t38","count":0,"unit":"all","label":"Alle"}],"axes":[{"id":"a27","label":"","loc":"","unit":"%","color":"#22c55e","autoscale":false,"min":0,"max":100}],"series":[{"id":"s28","symbol":"ADS.AF_PLC.MAIN.…::fWert","label":"Signal","loc":"","color":"#22c55e","axisId":"a27"}],"refLines":[],"eventMarkers":[],"showStats":true}]}
