...
/*
 * Aufruf am View-Event onAttached:   TcHmi.Functions.AC_HMI.AC_AccessEmbed('MeinContainer');
 * Abbau am View-Event onDetached:    TcHmi.Functions.AC_HMI.AC_AccessEmbedDestroy('MeinContainer');
...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        ...
        (function (AC_HMI) {
            ...
            function AC_AccessEmbedDestroy(target) {
                var container = resolveTarget(target);
                if (container && container.__acEmbedDestroy) { try { container.__acEmbedDestroy(); } catch (e) {} }
            }
            AC_HMI.AC_AccessEmbedDestroy = AC_AccessEmbedDestroy;

            function AC_AccessEmbed(target) {
    var container = resolveTarget(target);
    ...
    body.style.cssText = 'position:absolute;top:0;left:0;right:0;bottom:0;box-sizing:border-box;overflow:auto;padding:12px;color:' + p.bodyText + ';';
        ...
        var __acPopup = {"observe":["Admin","Service","Process_Engineer"]};
        if (!acAllowed(__acPopup.observe)) return; // Popup für diese Gruppe nicht anzeigen
        // Boolean-Anzeige: ADS.…::xRun
        (function () {
            ...
            lbl.textContent = "Läuft";
            row.appendChild(dot); row.appendChild(lbl);
            body.appendChild(row);
            subscribe("%s%ADS.…::xRun%/s%", function (v) { dot.style.background = v ? p.active : p.inactive; });
        })();

        // Baustein mit Gruppen-Berechtigung
        (function () {
            var __acR = {"operate":["Admin","Service"]};
        ...
        (function () {
            ...
            var ARRAY_SYMBOL = "%s%ADS.…::aAlarms%/s%";
            var COUNT_SYMBOL = '';
            var ARRAY_COUNT = 6;
            var START_INDEX = 0;
    ...
    container.__acEmbedDestroy = function () {
        ...
        try { delete container.__acEmbedDestroy; } catch (e) { container.__acEmbedDestroy = null; }
            ...
            AC_HMI.AC_AccessEmbed = AC_AccessEmbed;
        })(AC_HMI = Functions.AC_HMI || (Functions.AC_HMI = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx("AC_AccessEmbed", 'TcHmi.Functions.AC_HMI', TcHmi.Functions.AC_HMI.AC_AccessEmbed);
TcHmi.Functions.registerFunctionEx("AC_AccessEmbedDestroy", 'TcHmi.Functions.AC_HMI', TcHmi.Functions.AC_HMI.AC_AccessEmbedDestroy);

// ── AC_PopUp Generator: Konfiguration für Re-Import (diese Zeilen nicht entfernen) ──
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"embed","fnName":"AC_AccessEmbed","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":560,"columns":1,"hostSuffix":".btn_PopUp","blocks":[{"id":"b87","type":"bool","col":0,"label":"Läuft","loc":"","symbol":"ADS.…::xRun"},{"id":"b88","type":"table","col":0,"caption":"Alarme","captionLoc":"","dataSource":"array","arraySymbol":"ADS.…::aAlarms","arrayCount":6,"countSymbol":"","startIndex":0,"showIndex":false,"columns":[{"id":"tc101","kind":"read","header":"Wert","headerLoc":"","headerIcon":"","headerIconColor":"","member":"rValue","unit":"bar","decimals":1,"label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1},{"id":"tc102","kind":"check","header":"Quittieren","headerLoc":"","headerIcon":"","headerIconColor":"","member":"xAck","unit":"","decimals":"","label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1}],"rows":[],"search":true,"pageSize":0,"striped":true,"showHeader":true,"watchLimit":30,"pollMs":1000,"rules":[],"rowFilters":[],"defaultSortCol":-1,"defaultSortDir":"asc","access":{"observe":{"on":false,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Allow","Operator":"Allow"}},"operate":{"on":true,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Deny","Operator":"Deny"}}}}],"access":{"observe":{"on":true,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Allow","Operator":"Deny"}},"operate":{"on":false,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Allow","Operator":"Allow"}}}}
