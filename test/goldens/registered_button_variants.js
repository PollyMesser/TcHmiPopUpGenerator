...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        var AC_HMI;
        (function (AC_HMI) {
            function AC_ButtonMatrix(par1) {
                var uid = "AC_ButtonMatrix";
                ...
                function buildDialog() {
                    ...
                    (function () {
                        ...
                        btn0.onclick = function (e) { e.stopPropagation(); pulseSymbol("%s%ADS.…::xPulse%/s%", 150);
                            hideDialog(); };
                        btn0.style.display = 'none';
                        subscribe("%s%ADS.…::xVisible%/s%", function (vis) { btn0.style.display = vis ? '' : 'none'; });
                        ...
                        btn1.textContent = "SetFalse";
                        btn1.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
                        btn1.onclick = function (e) { e.stopPropagation(); writeSymbol("%s%ADS.…::xFlag%/s%", false);
                            hideDialog(); };
                        ...
                        (function () {
                            var vals = [null, null];
                            function upd() {
                                var enabled = (Number(vals[0]) < 3) && (Number(vals[1]) >= 1);
                                btn1.disabled = !enabled;
                                btn1.style.opacity = enabled ? '1' : '0.45';
                                btn1.style.cursor = enabled ? 'pointer' : 'not-allowed';
                            }
                            subscribe("%s%ADS.…::nMode%/s%", function (v) { vals[0] = v; upd(); });
                            subscribe("%s%ADS.…::nMode%/s%", function (v) { vals[1] = v; upd(); });
                            upd();
                        })();
                    ...
                    (function () {
                        ...
                        var btn0 = document.createElement('button');
                        btn0.style.cssText = 'flex:1;padding:12px 0;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;background:#3b82f6;color:#ffffff;';
                        btn0.textContent = "Toggle";
                        btn0.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
                        btn0.onclick = function (e) { e.stopPropagation(); toggleSymbol("%s%ADS.…::xToggle%/s%");
                            hideDialog(); };
                        btn0.style.transition = 'transform .08s ease, filter .08s ease';
                        btn0.addEventListener('pointerdown', function () { btn0.style.transform = 'scale(0.96)'; btn0.style.filter = 'brightness(0.88)'; });
                        var rel_btn0 = function () { btn0.style.transform = ''; btn0.style.filter = ''; };
            ...
            AC_HMI.AC_ButtonMatrix = AC_ButtonMatrix;
        })(AC_HMI = Functions.AC_HMI || (Functions.AC_HMI = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx("AC_ButtonMatrix", 'TcHmi.Functions.AC_HMI', TcHmi.Functions.AC_HMI.AC_ButtonMatrix);

// ── AC_PopUp Generator: Konfiguration für Re-Import (diese Zeilen nicht entfernen) ──
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"registered","fnName":"AC_ButtonMatrix","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":400,"columns":1,"hostSuffix":".btn_PopUp","blocks":[{"id":"b39","type":"button","col":0,"buttons":[{"label":"Pulse","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"ADS.…::xPulse","writeMode":"pulse","pulseMs":150,"closeAfter":true,"color":"blue","visSym":"ADS.…::xVisible","enableIf":[],"fbSym":"","confirmMs":3000,"confirmAction":"pulse"},{"label":"SetFalse","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"ADS.…::xFlag","writeMode":"setFalse","pulseMs":500,"closeAfter":true,"color":"blue","visSym":"","enableIf":[{"id":"c29","symbol":"ADS.…::nMode","op":"<","value":"3"},{"id":"c30","symbol":"ADS.…::nMode","op":">=","value":"1"}],"fbSym":"","confirmMs":3000,"confirmAction":"pulse"}]},{"id":"b40","type":"button","col":0,"buttons":[{"label":"Toggle","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"ADS.…::xToggle","writeMode":"toggle","pulseMs":500,"closeAfter":true,"color":"blue","visSym":"","enableIf":[{"id":"c31","symbol":"ADS.…::eStep","op":"<=","value":"2"}],"fbSym":"","confirmMs":3000,"confirmAction":"pulse"}]}]}
