...
(function (ev) {
    ...
    var host = null;
    var clicked = (ev && ev.target && ev.target.closest) ? ev.target.closest('[id$=".btn_PopUp"]') : null;
    if (clicked) {
        var hostId = clicked.id.split(".btn_PopUp")[0];
        host = TcHmi.Controls.get(hostId);
    }

    var uid = "AC_UcButtonMatrix" + '_' + (host ? String(host.getId()).replace(/[^A-Za-z0-9_]/g, '_') : 'popup');
    ...
    function buildDialog() {
        ...
        (function () {
            ...
            btn0.textContent = "Pulse";
            btn0.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
            btn0.onclick = function (e) { e.stopPropagation(); pulse("Pulse", 200);
                hideDialog(); };
            btn0.style.display = 'none';
            updaters.push(function () { btn0.style.display = gv("Visible", false) ? '' : 'none'; });
            ...
            btn1.textContent = "Hold";
            btn1.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
            btn1.addEventListener('pointerdown', function () { if (btn1.disabled) return; sv("Hold", true); });
            var release_btn1 = function () { if (btn1.disabled) return; sv("Hold", false);
                hideDialog(); };
            btn1.addEventListener('pointerup', release_btn1);
            btn1.addEventListener('pointerleave', release_btn1);
            updaters.push(function () { btn1.style.boxShadow = gv("HoldConfirmed", false) ? '0 0 0 3px #22c55e' : 'none'; });
        ...
        // Button (Zeilen-Element, Attribut): toggle: ItemFlag
        (function () {
            var btn = document.createElement('button');
            btn.style.cssText = 'width:100%;padding:12px 0;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;background:#3b82f6;color:#ffffff;';
            btn.textContent = "Item-Toggle";
            btn.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
            btn.onclick = function (e) { e.stopPropagation(); sv("ItemFlag", !gv("ItemFlag", false));
                hideDialog(); };
            ...
            (function () {
                function upd() {
                    var enabled = (Number(gv("Mode", null)) > 0);
...
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"usercontrol","fnName":"AC_UcButtonMatrix","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":400,"columns":1,"hostSuffix":".btn_PopUp","blocks":[{"id":"b41","type":"button","col":0,"buttons":[{"label":"Pulse","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"Pulse","writeMode":"pulse","pulseMs":200,"closeAfter":true,"color":"blue","visSym":"Visible","enableIf":[],"fbSym":"","confirmMs":3000,"confirmAction":"pulse"},{"label":"Hold","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"Hold","writeMode":"hold","pulseMs":500,"closeAfter":true,"color":"blue","visSym":"","enableIf":[],"fbSym":"HoldConfirmed","confirmMs":3000,"confirmAction":"pulse"}]},{"id":"b42","type":"row","col":0,"items":[{"id":"b45","kind":"button","label":"Item-Toggle","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"ItemFlag","writeMode":"toggle","pulseMs":500,"closeAfter":true,"color":"blue","visSym":"","enableIf":[{"id":"c32","symbol":"Mode","op":">","value":"0"}],"fbSym":"","confirmMs":3000,"confirmAction":"pulse"}]}]}
