...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        var AC_HMI;
        (function (AC_HMI) {
            function AC_AccessPerBlock(par1) {
                var uid = "AC_AccessPerBlock";
                ...
                function buildDialog() {
                    ...
                    (function () {
                        ...
                        subscribe("%s%ADS.…::rSecret%/s%", function (v) { valEl.textContent = String(v) + ""; });
                    })();
                    ...
                    (function () {
                        ...
                        var accW = document.createElement('div');
                        accW.style.cssText = 'min-width:0;';
                    // Boolean setzen (Checkbox): ADS.…::xLocked
                    (function () {
                        ...
                        subscribe("%s%ADS.…::xLocked%/s%", function (v) { if (document.activeElement !== cb) cb.checked = !!v; });
                        cb.addEventListener('change', function () { writeSymbol("%s%ADS.…::xLocked%/s%", cb.checked); });
                    })();
                        if (!acAllowed(__acR.operate)) {
                            var __acE = accW.querySelectorAll('button, input, select, textarea');
                            for (var __aci = 0; __aci < __acE.length; __aci++) { if (__acE[__aci].getAttribute && __acE[__aci].getAttribute('data-ac-view')) continue; __acE[__aci].disabled = true; }
                    ...
                    // Baustein mit Gruppen-Berechtigung
                    (function () {
                        var __acR = {"observe":["Admin","Service","Process_Engineer"],"operate":["Admin"]};
                        if (!acAllowed(__acR.observe)) return;
                        var accW = document.createElement('div');
                        accW.style.cssText = 'min-width:0;';
                    // Buttons
                    (function () {
                        ...
                        btn0.textContent = "Kritisch";
                        btn0.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
                        btn0.onclick = function (e) { e.stopPropagation(); writeSymbol("%s%ADS.…::xCritical%/s%", true);
                            hideDialog(); };
                    ...
                    // Wert lesen: ADS.…::rOpen
                    (function () {
                        var row = document.createElement('div');
                        row.style.cssText = 'display:flex;align-items:baseline;justify-content:space-between;gap:8px;margin-bottom:16px;';
                        var lbl = document.createElement('span');
                        lbl.style.cssText = 'font-size:14px;color:' + p.bodyText + ';';
                        lbl.textContent = "Frei";
                        var valEl = document.createElement('span');
                        valEl.style.cssText = 'font-size:14px;font-weight:500;color:' + p.bodyText + ';text-align:right;font-variant-numeric:tabular-nums;';
                        valEl.textContent = '…';
                        row.appendChild(lbl); row.appendChild(valEl);
                        body.appendChild(row);
                        subscribe("%s%ADS.…::rOpen%/s%", function (v) { valEl.textContent = String(v) + ""; });
                    })();
            ...
            AC_HMI.AC_AccessPerBlock = AC_AccessPerBlock;
        })(AC_HMI = Functions.AC_HMI || (Functions.AC_HMI = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx("AC_AccessPerBlock", 'TcHmi.Functions.AC_HMI', TcHmi.Functions.AC_HMI.AC_AccessPerBlock);

// ── AC_PopUp Generator: Konfiguration für Re-Import (diese Zeilen nicht entfernen) ──
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"registered","fnName":"AC_AccessPerBlock","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":400,"columns":1,"hostSuffix":".btn_PopUp","blocks":[{"id":"b81","type":"read","col":0,"label":"Nur Sehen","loc":"","symbol":"ADS.…::rSecret","unit":"","access":{"observe":{"on":true,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Deny","Operator":"Deny"}},"operate":{"on":false,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Allow","Operator":"Allow"}}}},{"id":"b82","type":"check","col":0,"label":"Nur Bedienen","loc":"","symbol":"ADS.…::xLocked","access":{"observe":{"on":false,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Allow","Operator":"Allow"}},"operate":{"on":true,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Deny","Operator":"Deny"}}}},{"id":"b83","type":"button","col":0,"buttons":[{"label":"Kritisch","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"ADS.…::xCritical","writeMode":"setTrue","pulseMs":500,"closeAfter":true,"color":"blue","visSym":"","enableIf":[],"fbSym":"","confirmMs":3000,"confirmAction":"pulse"}],"access":{"observe":{"on":true,"groups":{"Admin":"Allow","Service":"Allow","Process_Engineer":"Allow","Operator":"Deny"}},"operate":{"on":true,"groups":{"Admin":"Allow","Service":"Deny","Process_Engineer":"Deny","Operator":"Deny"}}}},{"id":"b84","type":"read","col":0,"label":"Frei","loc":"","symbol":"ADS.…::rOpen","unit":""}]}
