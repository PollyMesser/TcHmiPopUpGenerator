...
/*
 * Aufruf am View-Event onAttached:   TcHmi.Functions.AC_HMI.AC_EmbedBasic('MeinContainer');
 * Abbau am View-Event onDetached:    TcHmi.Functions.AC_HMI.AC_EmbedBasicDestroy('MeinContainer');
...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        ...
        (function (AC_HMI) {
            ...
            function AC_EmbedBasicDestroy(target) {
                var container = resolveTarget(target);
                if (container && container.__acEmbedDestroy) { try { container.__acEmbedDestroy(); } catch (e) {} }
            }
            AC_HMI.AC_EmbedBasicDestroy = AC_EmbedBasicDestroy;

            function AC_EmbedBasic(target) {
    var container = resolveTarget(target);
    ...
    body.style.cssText = 'position:absolute;top:0;left:0;right:0;box-sizing:border-box;padding:12px;color:' + p.bodyText + ';';
        ...
        // Boolean-Anzeige: ADS.…::xConnected
        (function () {
            ...
            subscribe("%s%ADS.…::xConnected%/s%", function (v) { dot.style.background = v ? p.active : p.inactive; });
        })();

        // Eingabefeld + Senden: ADS.…::nEmbedSet
        (function () {
            ...
            subscribe("%s%ADS.…::nEmbedSet%/s%", function (v) { if (document.activeElement !== input) input.value = String(v); });
            function commit() { var val = parseFloat(input.value); if (isNaN(val)) return; writeSymbol("%s%ADS.…::nEmbedSet%/s%", val); }
        ...
        (function () {
            ...
            btn0.textContent = "Anwenden";
            btn0.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
            btn0.onclick = function (e) { e.stopPropagation(); pulseSymbol("%s%ADS.…::xApply%/s%", 500); };
    ...
    container.__acEmbedDestroy = function () {
        ...
        try { delete container.__acEmbedDestroy; } catch (e) { container.__acEmbedDestroy = null; }
            ...
            AC_HMI.AC_EmbedBasic = AC_EmbedBasic;
        })(AC_HMI = Functions.AC_HMI || (Functions.AC_HMI = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx("AC_EmbedBasic", 'TcHmi.Functions.AC_HMI', TcHmi.Functions.AC_HMI.AC_EmbedBasic);
TcHmi.Functions.registerFunctionEx("AC_EmbedBasicDestroy", 'TcHmi.Functions.AC_HMI', TcHmi.Functions.AC_HMI.AC_EmbedBasicDestroy);

// ── AC_PopUp Generator: Konfiguration für Re-Import (diese Zeilen nicht entfernen) ──
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"embed","fnName":"AC_EmbedBasic","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":480,"columns":1,"hostSuffix":".btn_PopUp","blocks":[{"id":"b70","type":"bool","col":0,"label":"Verbunden","loc":"","symbol":"ADS.…::xConnected"},{"id":"b71","type":"input","col":0,"label":"Sollwert","loc":"","symbol":"ADS.…::nEmbedSet","dataType":"number","unit":"","sendLabel":"Setzen","sendLoc":"","sendColor":"blue","trigSym":"","trigMode":"pulse","trigMs":500},{"id":"b72","type":"button","col":0,"buttons":[{"label":"Anwenden","loc":"","icon":"","iconPos":"left","showLabel":true,"symbol":"ADS.…::xApply","writeMode":"pulse","pulseMs":500,"closeAfter":false,"color":"green","visSym":"","enableIf":[],"fbSym":"","confirmMs":3000,"confirmAction":"pulse"}]},{"id":"b73","type":"table","col":0,"caption":"Embed-Tabelle","captionLoc":"","dataSource":"static","arraySymbol":"","arrayCount":10,"countSymbol":"","startIndex":0,"showIndex":false,"columns":[{"id":"tc71","kind":"read","header":"Wert","headerLoc":"","headerIcon":"","headerIconColor":"","member":"","unit":"%","decimals":0,"label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1}],"rows":[{"id":"tr72","cells":[{"symbol":"ADS.…::rEmbed","text":"","loc":""}]},{"id":"tr73","cells":[{"symbol":"ADS.…::rEmbed","text":"","loc":""}]}],"search":false,"pageSize":0,"striped":true,"showHeader":true,"watchLimit":30,"pollMs":1000,"rules":[],"rowFilters":[],"defaultSortCol":-1,"defaultSortDir":"asc"}]}
