...
(function (ev) {
    ...
    var host = null;
    var clicked = (ev && ev.target && ev.target.closest) ? ev.target.closest('[id$=".btn_Table"]') : null;
    if (clicked) {
        var hostId = clicked.id.split(".btn_Table")[0];
        host = TcHmi.Controls.get(hostId);
    }

    var uid = "AC_UcTable" + '_' + (host ? String(host.getId()).replace(/[^A-Za-z0-9_]/g, '_') : 'popup');
    ...
    function buildDialog() {
        ...
        (function () {
            ...
            updaters.push(function () { valEl.textContent = String(gv("Overview", '')) + ""; });
        })();
        ...
        // Boolean setzen (Attribut, Checkbox): Confirmed
        (function () {
            ...
            body.appendChild(wrap);
            cb.addEventListener('pointerdown', function (e) { e.stopPropagation(); });
            cb.addEventListener('change', function () { sv("Confirmed", cb.checked); });
            updaters.push(function () { if (document.activeElement !== cb) cb.checked = !!gv("Confirmed", false); });
        })();
...
// AC_POPUP_CONFIG_V1: {"v":1,"mode":"usercontrol","fnName":"AC_UcTable","title":"Titel","titleLoc":"","titleSource":"static","titleField":"TagName","titleFallback":"Titel","titleIcon":"","titleIconColor":"","maxWidth":400,"columns":1,"hostSuffix":".btn_Table","blocks":[{"id":"b50","type":"read","col":0,"label":"Übersicht","loc":"","symbol":"Overview","unit":""},{"id":"b51","type":"table","col":0,"caption":"Messwerte","captionLoc":"","dataSource":"static","arraySymbol":"","arrayCount":10,"countSymbol":"","startIndex":0,"showIndex":true,"columns":[{"id":"tc65","kind":"read","header":"Messwert","headerLoc":"","headerIcon":"","headerIconColor":"","member":"","unit":"°C","decimals":1,"label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1},{"id":"tc66","kind":"text","header":"Kommentar","headerLoc":"","headerIcon":"","headerIconColor":"","member":"","unit":"","decimals":"","label":"","loc":"","writeMode":"setTrue","pulseMs":300,"map":[],"sortable":false,"action":"symbol","fnName":"","paramSource":"member","paramMember":"","paramCol":-1}],"rows":[{"id":"tr67","cells":[{"symbol":"ADS.…::rTemp","text":"","loc":""},{"symbol":"","text":"OK","loc":""}]},{"id":"tr68","cells":[{"symbol":"ADS.…::rTemp","text":"","loc":""},{"symbol":"","text":"OK","loc":""}]}],"search":false,"pageSize":0,"striped":true,"showHeader":true,"watchLimit":30,"pollMs":1000,"rules":[],"rowFilters":[],"defaultSortCol":-1,"defaultSortDir":"asc"},{"id":"b52","type":"check","col":0,"label":"Bestätigt","loc":"","symbol":"Confirmed"}]}
